...
{
	// We don't want to restart text input, also we don't want to call non-existent function.
...
{
	// We don't want to restop text input, also we don't want to call non-existent function.
